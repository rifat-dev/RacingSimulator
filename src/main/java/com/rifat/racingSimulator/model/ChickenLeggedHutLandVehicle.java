...
@Entity
@DiscriminatorValue("ChickenLeggedHutLandVehicle")
public class ChickenLeggedHutLandVehicle extends LandVehicle {


    public ChickenLeggedHutLandVehicle() {
    }

    public ChickenLeggedHutLandVehicle(double speed, double moveTimeBeforeRest) {
    ...
    double totalRestTime(int stopSequence) {
        ...
        DoubleUnaryOperator func = x -> Math.pow(x, x / 10);
